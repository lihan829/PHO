...
\newcommand{\hihan}[1]{\textcolor{blue}{\textbf{[#1]}}}
...
\hihan{Well it hasn't been accepted so it's just a manuscript at this point.}
...
\hijeff{On a second reading, I think this paragraph is still technically correct, but it now feels somewhat outdated. It reads like that we dont know whether transformations can be modeled over ARs, but we now know its possible, and exactly how do to}\hihan{I think it is fine to leave it as is.}
...
\hijeff{I added the paragraph of math disclaimer back but
 this is what R3 asked us to remove...}
\hijeff{How about this: Section~\ref{sec:prelim} and ~\ref{sec:bufiaar}
  are technical, and researchers only interested in BUFIA-AR's
  performance may skip them.
  Nonetheless, these sections are important because they provide \ldots}
...
in \ref{fig.restriction:b} because the dotted region in
...
\(\{aba, baabaa\}\).  BUFIA begins from the most general hothesis:
...
line-crossing violation \ref{bad.assoc1}. A column or
...
\hijeff{special letters won't show}\hihan{that's weird. How about ``labialized and palatalized velar forms''}
% see https://brucehayes.org/251HayesSchuhMetrics/handouts/02_Hausa_phonology.pdf
...
\toprule
		\textbf{Form} & \textbf{Tones} & \textbf{AR Diagram}  & \textbf{Matrix-based Coding} \\
		\hline
...
%\subsection{Gradience versus Categoricity in Grammars} \label{sec:discussion.grammar}
...
Workshop, \hihan{Yale's Phonology group?}, in addition to Ellen Broselow, Thomas Graf, Jiwon 
Yun, and Adam Jardine. Finally, we are grateful for the detailed and constructive feedback from three anonymous reviewers, the Editor, and the Associate Editor, which greatly improved and strengthened both this paper's analysis and presentation.

\paragraph{Funding statement}
This research was supported by NSF grant \#2416183 to JH.
\hijeff{do you have funding to report}\hihan{Done}
\paragraph{Data availability statement}
Replication data and code can be found in GitHub repository: \url{https://github.com/lihan829/BUFIA_AR.git}.
\hihan{Do you want to take a snapshot of your corpus and code and put it on Dryad? That is another way to archive material and I think it may be more sustainable in the long run than github. MLRegTest is on Dryad: \url{https://doi.org/10.5061/dryad.dncjsxm4h}}
\paragraph{Ethical standards}
The research meets all ethical guidelines, including adherence to the legal requirements of the study country.

\paragraph{Author contributions}
\hihan{HL and JH conceived of the project. HL developed BUFIA-AR, }
curated the data, conducted the case study, and
wrote the first draft of the manuscript.
HL and JH revised the manuscript and approved the final version.
