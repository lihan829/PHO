...
Workshop, Yale's Phonology Group, in addition to Ellen Broselow, Thomas Graf, Jiwon 
Yun, and Adam Jardine. Finally, we are grateful for the detailed and constructive 
feedback from three anonymous reviewers, the Editor, and the Associate Editor, 
which greatly improved and strengthened both this paper's analysis and presentation.

\paragraph{Funding statement}
This research was supported by NSF grant \#2416183 to JH.

\paragraph{Data availability statement}
Replication data and source code are available from the Dryad Digital Repository: \url{https://doi.org/10.5061/dryad.dncjsxmfg}.
\paragraph{Ethical standards}
The research meets all ethical guidelines, including adherence to the legal requirements of the study country.

\paragraph{Author contributions}
\text{HL and JH conceived of the project and developed BUFIA-AR.} 
HL curated the data, conducted the case study, and wrote the first 
draft of the manuscript. HL and JH revised the manuscript and 
